...
# Read the HTML file
url <- "https://www.amazon.com/s?i=specialty-aps&bbn=16225009011&rh=n%3A%2116225009011%2Cn%3A524136&ref=nav_em__nav_desktop_sa_intl_security_and_surveillance_0_2_5_12"
...
write.csv(product_df1, "p1.csv")


product_df1$Category <- "Security & Surveillance Equipment"


product_df1 <- product_df1[, c("Category", names(product_df1)[-which(names(product_df1) == "Category")])]


write.csv(product_df1, "p1_final.csv", row.names = FALSE)