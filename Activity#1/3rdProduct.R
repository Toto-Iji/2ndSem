...
# Read the HTML file
url <- "https://www.amazon.com/s?i=specialty-aps&bbn=16225009011&rh=n%3A%2116225009011%2Cn%3A1266092011&ref=nav_em__nav_desktop_sa_intl_television_and_video_0_2_5_14"
...
write.csv(product_df3, "p3.csv")



product_df3$Category <- "Televisions & Video Products"


product_df3 <- product_df3[, c("Category", names(product_df3)[-which(names(product_df3) == "Category")])]


write.csv(product_df3, "p3_Final.csv", row.names = FALSE)