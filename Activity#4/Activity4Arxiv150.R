...
url <- 'https://arxiv.org/search/?query=%22nuclear%22&searchtype=all&abstracts=show&order=-announced_date_first&size=50'
...
# Save the result
save(papers, file = "ArxivNuclear150.RData")
write.csv(papers, file = "Arxiv_NuclearPapers150.csv")
